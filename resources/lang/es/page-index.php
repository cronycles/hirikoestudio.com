...
return [
    ...
    'presentation-section-title' => 'El Estudio',
    'presentation-section-subtitle' => 'En Hiriko Estudio desarrollamos proyectos de
                                        <strong> Arquitectura Urbanismo, Interiorismo, Reformas integrales, Obra nueva y Contract.</strong>',
    'presentation-section-text' => '<p>Hiriko Estudio nace como Estudio de Arquitectura en 2017, enfocado a la arquitectura de interiores, obra nueva y urbanismo.
                                    El nombre del estudio no es casual. Hiria significa ciudad en euskera, y con ello pretendemos evocar la idea de colectividad.
